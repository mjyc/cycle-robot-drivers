...
(function (SIGType) {
    ...
    SIGType["SAY_DONE"] = "SAY_DONE";
})(SIGType || (SIGType = {}));
function input(goal$, questionAnswerResult$, monologueResult$) {
    return xstream_1.default.merge(goal$.filter(function (g) { return typeof g !== 'undefined'; }).map(function (g) { return (g === null)
        ...
        : ({ type: SIGType.GOAL, value: action_1.initGoal(g) }); }), questionAnswerResult$
        ...
        .filter(function (r) { return r.status.status !== action_1.Status.SUCCEEDED; })
        .map(function (r) { return ({ type: SIGType.QA_FAILED, value: r.result }); }), monologueResult$
        .filter(function (r) { return r.status.status === action_1.Status.SUCCEEDED; })
...
function reducer(input$) {
    ...
    var transitionReducer$ = xstream_1.default.never();
...
function FlowchartAction(sources) {
    ...
    var qaSinks = isolate_1.default(actionbank_1.QAWithScreenAction, 'QAAction')(sources);
    var reducerState$ = sources.state.stream;
    var questionAnswerResult$ = reducerState$
        .compose(actionbank_1.selectActionResult('QAAction'));
    questionAnswerResult$.addListener({
        next: function (r) { return console.log('questionAnswerResult$', r); },
    });
    qaSinks.result.addListener({
        next: function (r) { return console.log('qaSinks.result', r); },
    });
    var input$ = input(sources.goal, questionAnswerResult$, sources.SpeechSynthesisAction.result);
    var parentReducer$ = reducer(input$);
    var reducer$ = xstream_1.default.merge(parentReducer$, qaSinks.state);
    return {
...
},{"@cycle-robot-drivers/action":1,"@cycle-robot-drivers/actionbank":75,"@cycle/isolate":24,"xstream":69}],71:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
...
},{"./FlowchartAction":70,"@cycle-robot-drivers/actionbank":75,"@cycle-robot-drivers/screen":90,"@cycle-robot-drivers/speech":148,"@cycle/dom":17,"@cycle/isolate":24,"xstream":69,"xstream/extra/delay":66}],72:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var dom_1 = require("@cycle/dom");
...
},{"./RobotApp":71,"@cycle-robot-drivers/screen":90,"@cycle-robot-drivers/speech":148,"@cycle/dom":17,"@cycle/run":28,"@cycle/state":32}],73:[function(require,module,exports){
"use strict";
...
},{"./QuestionAnswerAction":74,"./makeConcurrentAction":76,"./utils":77,"@cycle/isolate":81,"xstream":86}],74:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
...
},{"@cycle-robot-drivers/action":78,"xstream":86}],75:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var utils_1 = require("./utils");
...
},{"./QAWithScreenAction":73,"./QuestionAnswerAction":74,"./makeConcurrentAction":76,"./utils":77}],76:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
...
},{"@cycle-robot-drivers/action":78,"xstream":86}],77:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"@cycle-robot-drivers/action":78,"xstream/extra/dropRepeats":85}],78:[function(require,module,exports){
arguments[4][1][0].apply(exports,arguments)
},{"./types":79,"./utils":80,"dup":1}],79:[function(require,module,exports){
arguments[4][2][0].apply(exports,arguments)
},{"dup":2}],80:[function(require,module,exports){
arguments[4][3][0].apply(exports,arguments)
},{"dup":3}],81:[function(require,module,exports){
arguments[4][24][0].apply(exports,arguments)
},{"@cycle/run/lib/adapt":82,"dup":24,"xstream":86}],82:[function(require,module,exports){
(function (global){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
function getGlobal() {
...
},{"./ponyfill.js":84}],84:[function(require,module,exports){
arguments[4][59][0].apply(exports,arguments)
},{"dup":59}],85:[function(require,module,exports){
arguments[4][67][0].apply(exports,arguments)
},{"../index":86,"dup":67}],86:[function(require,module,exports){
arguments[4][69][0].apply(exports,arguments)
},{"dup":69,"symbol-observable":83}],87:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
...
arguments[4][1][0].apply(exports,arguments)
},{"./types":93,"./utils":94,"dup":1}],93:[function(require,module,exports){
arguments[4][2][0].apply(exports,arguments)
},{"dup":2}],94:[function(require,module,exports){
arguments[4][3][0].apply(exports,arguments)
},{"dup":3}],95:[function(require,module,exports){
arguments[4][4][0].apply(exports,arguments)
},{"./fromEvent":106,"@cycle/run/lib/adapt":116,"dup":4,"xstream":145}],96:[function(require,module,exports){
arguments[4][5][0].apply(exports,arguments)
},{"./fromEvent":106,"@cycle/run/lib/adapt":116,"dup":5,"xstream":145}],97:[function(require,module,exports){
arguments[4][6][0].apply(exports,arguments)
},{"./ScopeChecker":103,"./utils":114,"dup":6}],98:[function(require,module,exports){
arguments[4][7][0].apply(exports,arguments)
},{"./ElementFinder":97,"./PriorityQueue":101,"./RemovalSet":102,"./ScopeChecker":103,"./SymbolTree":104,"./fromEvent":106,"./utils":114,"dup":7,"xstream":145}],99:[function(require,module,exports){
arguments[4][8][0].apply(exports,arguments)
},{"./SymbolTree":104,"./utils":114,"dup":8}],100:[function(require,module,exports){
arguments[4][9][0].apply(exports,arguments)
},{"./BodyDOMSource":95,"./DocumentDOMSource":96,"./ElementFinder":97,"./isolate":109,"@cycle/run/lib/adapt":116,"dup":9}],101:[function(require,module,exports){
arguments[4][10][0].apply(exports,arguments)
},{"dup":10}],102:[function(require,module,exports){
arguments[4][11][0].apply(exports,arguments)
},{"dup":11}],103:[function(require,module,exports){
arguments[4][12][0].apply(exports,arguments)
},{"./utils":114,"dup":12}],104:[function(require,module,exports){
arguments[4][13][0].apply(exports,arguments)
},{"dup":13}],105:[function(require,module,exports){
arguments[4][14][0].apply(exports,arguments)
},{"./utils":114,"dup":14,"snabbdom-selector":120,"snabbdom/h":124,"snabbdom/vnode":135}],106:[function(require,module,exports){
arguments[4][15][0].apply(exports,arguments)
},{"dup":15,"xstream":145}],107:[function(require,module,exports){
arguments[4][16][0].apply(exports,arguments)
},{"dup":16,"snabbdom/h":124}],108:[function(require,module,exports){
arguments[4][17][0].apply(exports,arguments)
},{"./MainDOMSource":100,"./hyperscript-helpers":107,"./makeDOMDriver":110,"./mockDOMSource":111,"./thunk":113,"dup":17,"snabbdom/h":124}],109:[function(require,module,exports){
arguments[4][18][0].apply(exports,arguments)
},{"./utils":114,"dup":18}],110:[function(require,module,exports){
arguments[4][19][0].apply(exports,arguments)
},{"./EventDelegator":98,"./IsolateModule":99,"./MainDOMSource":100,"./VNodeWrapper":105,"./modules":112,"./utils":114,"dup":19,"snabbdom":132,"snabbdom/tovnode":134,"xstream":145,"xstream/extra/concat":142,"xstream/extra/sampleCombine":144}],111:[function(require,module,exports){
arguments[4][20][0].apply(exports,arguments)
},{"@cycle/run/lib/adapt":116,"dup":20,"xstream":145}],112:[function(require,module,exports){
arguments[4][21][0].apply(exports,arguments)
},{"dup":21,"snabbdom/modules/attributes":127,"snabbdom/modules/class":128,"snabbdom/modules/dataset":129,"snabbdom/modules/props":130,"snabbdom/modules/style":131}],113:[function(require,module,exports){
arguments[4][22][0].apply(exports,arguments)
},{"dup":22,"snabbdom/h":124}],114:[function(require,module,exports){
arguments[4][23][0].apply(exports,arguments)
},{"dup":23}],115:[function(require,module,exports){
arguments[4][24][0].apply(exports,arguments)
},{"@cycle/run/lib/adapt":116,"dup":24,"xstream":145}],116:[function(require,module,exports){
(function (global){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
function getGlobal() {
...
},{"./selectorParser":123,"dup":39}],118:[function(require,module,exports){
arguments[4][40][0].apply(exports,arguments)
},{"dup":40}],119:[function(require,module,exports){
arguments[4][41][0].apply(exports,arguments)
},{"./parent-symbol":121,"./query":122,"dup":41}],120:[function(require,module,exports){
arguments[4][42][0].apply(exports,arguments)
},{"./classNameFromVNode":117,"./curry2":118,"./findMatches":119,"./selectorParser":123,"dup":42}],121:[function(require,module,exports){
(function (global){
"use strict";
var root;
if (typeof self !== 'undefined') {
...
},{"./classNameFromVNode":117,"./parent-symbol":121,"./selectorParser":123,"dup":44,"tree-selector":138}],123:[function(require,module,exports){
arguments[4][45][0].apply(exports,arguments)
},{"dup":45}],124:[function(require,module,exports){
arguments[4][46][0].apply(exports,arguments)
},{"./is":126,"./vnode":135,"dup":46}],125:[function(require,module,exports){
arguments[4][47][0].apply(exports,arguments)
},{"dup":47}],126:[function(require,module,exports){
arguments[4][48][0].apply(exports,arguments)
},{"dup":48}],127:[function(require,module,exports){
...
},{"./h":124,"./htmldomapi":125,"./is":126,"./thunk":133,"./vnode":135}],133:[function(require,module,exports){
arguments[4][55][0].apply(exports,arguments)
},{"./h":124,"dup":55}],134:[function(require,module,exports){
arguments[4][56][0].apply(exports,arguments)
},{"./htmldomapi":125,"./vnode":135,"dup":56}],135:[function(require,module,exports){
...
arguments[4][59][0].apply(exports,arguments)
},{"dup":59}],138:[function(require,module,exports){
arguments[4][61][0].apply(exports,arguments)
},{"./matches":139,"./querySelector":140,"./selectorParser":141,"dup":61}],139:[function(require,module,exports){
arguments[4][62][0].apply(exports,arguments)
},{"./selectorParser":141,"dup":62}],140:[function(require,module,exports){
arguments[4][63][0].apply(exports,arguments)
},{"./matches":139,"./selectorParser":141,"dup":63}],141:[function(require,module,exports){
arguments[4][64][0].apply(exports,arguments)
},{"dup":64}],142:[function(require,module,exports){
arguments[4][65][0].apply(exports,arguments)
},{"../index":145,"dup":65}],143:[function(require,module,exports){
arguments[4][67][0].apply(exports,arguments)
},{"../index":145,"dup":67}],144:[function(require,module,exports){
arguments[4][68][0].apply(exports,arguments)
},{"../index":145,"dup":68}],145:[function(require,module,exports){
arguments[4][69][0].apply(exports,arguments)
},{"dup":69,"symbol-observable":136}],146:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
...
arguments[4][1][0].apply(exports,arguments)
},{"./types":152,"./utils":153,"dup":1}],152:[function(require,module,exports){
arguments[4][2][0].apply(exports,arguments)
},{"dup":2}],153:[function(require,module,exports){
arguments[4][3][0].apply(exports,arguments)
},{"dup":3}],154:[function(require,module,exports){
(function (global){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
function getGlobal() {
...
arguments[4][69][0].apply(exports,arguments)
},{"dup":69,"symbol-observable":155}]},{},[72])
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
