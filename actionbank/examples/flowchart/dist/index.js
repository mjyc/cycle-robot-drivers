...
function FlowchartAction(sources) {
    ...
    return {
        ...
        TwoSpeechbubblesAction: qaSinks.TwoSpeechbubblesAction.compose(dropRepeats_1.default(action_1.isEqualGoal)).debug(function (v) { return console.log('TwoSpeech', v); }),
        SpeechSynthesisAction: xstream_1.default.merge(qaSinks.SpeechSynthesisAction.debug(function (v) { return console.log('SpeechSynth', v); }), outputs.MonologueAction.compose(dropRepeats_1.default(action_1.isEqualGoal)).debug(function (v) { return console.log('Monologue', v); })),
