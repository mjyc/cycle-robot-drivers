...
function input(goal$, speechSynthesisResult, speechRecognitionResult) {
    return xstream_1.default.merge(goal$.map(function (g) { return ({ type: SIGType.GOAL, value: action_1.initGoal(g) }); }), speechSynthesisResult
...
arguments[4][1][0].apply(exports,arguments)
},{"./types":138,"./utils":139,"dup":1}],138:[function(require,module,exports){
arguments[4][2][0].apply(exports,arguments)
