...
function QAWithScreenAction(sources) {
    ...
    sources.TwoSpeechbubblesAction.result.addListener({ next: function (v) { return console.error(v); } });
    ...
    raceSinks.result.addListener({ next: function (r) { return console.error('raceSinks.result', r); } });
...
function RobotApp(sources) {
    ...
    var childSinks = isolate_1.default(QAWithScreenAction_1.QAWithScreenAction)(__assign({}, sources, { goal: xstream_1.default.of({
            ...
            TwoSpeechbubblesAction: { message: 'Hello', choices: ['Hello'] },
        }).compose(delay_1.default(1000)), FacialExpressionAction: { result: facialExpressionResult$ }, TwoSpeechbubblesAction: { result: twoSpeechbubblesResult$.debug() }, SpeechSynthesisAction: { result: speechSynthesisResult$ }, SpeechRecognitionAction: { result: speechRecognitionResult$ } }));
...
},{"./QAWithScreenAction":70,"@cycle-robot-drivers/action":1,"@cycle-robot-drivers/screen":86,"@cycle-robot-drivers/speech":144,"@cycle/dom":17,"@cycle/isolate":24,"xstream":69,"xstream/extra/delay":66,"xstream/extra/dropRepeats":67}],73:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var dom_1 = require("@cycle/dom");
...
function makeConcurrentAction(actionNames, isRace) {
    ...
    var input = function (goal$, results) {
        ...
        results$.addListener({ next: function (v) { return console.warn('result', v); } });
        return xstream_1.default.merge(goal$.filter(function (g) { return typeof g !== 'undefined'; }).map(function (g) { return (g === null)
            ? ({ type: SIGType.CANCEL, value: null })
    ...
    return function ConcurrentAction(sources) {
        ...
        sources.TwoSpeechbubblesAction.result.addListener({ next: function (v) { return console.warn(v); } });
        var reducerState$ = sources.state.stream;
        var results = actionNames.map(function (x) { return sources[x].result.startWith(createDummyResult()); });
