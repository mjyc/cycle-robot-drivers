...
var actionNames = ['FacialExpressionAction', 'TwoSpeechbubblesAction'];
function input(goal$, results) {
...
},{"@cycle-robot-drivers/action":1,"xstream":75}],77:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
...
var AllAction_1 = __importDefault(require("./AllAction"));
function RobotApp(sources) {
    ...
    var twoSpeechbubblesResult$ = state$
        ...
        .compose(dropRepeats_1.default(action_1.isEqualResult));
    var childSinks = isolate_1.default(AllAction_1.default, 'AllAction')(__assign({}, sources, { goal: xstream_1.default.of({
...
},{"./AllAction":76,"@cycle-robot-drivers/action":1,"@cycle-robot-drivers/screen":7,"@cycle/dom":23,"@cycle/isolate":30,"xstream":75,"xstream/extra/delay":72,"xstream/extra/dropRepeats":73}],78:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
