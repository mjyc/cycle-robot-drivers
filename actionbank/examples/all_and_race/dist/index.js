...
function input(goal$) {
    return goal$.filter(function (goal) { return typeof goal !== 'undefined'; })
...
function AllAction(sources) {
    ...
    var reducer$ = reducer(xstream_1.default.never());
...
function RobotApp(sources) {
    ...
    var allAction = isolate_1.default(AllAction_1.default, 'AllAction')(sources);
...
},{"./AllAction":76,"@cycle-robot-drivers/screen":7,"@cycle/dom":23,"@cycle/isolate":30,"xstream":75,"xstream/extra/delay":72}],78:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
