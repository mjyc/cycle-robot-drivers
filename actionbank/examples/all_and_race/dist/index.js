...
function RobotApp(sources) {
    ...
    var twoSpeechbubblesResult$ = state$
        ...
        .compose(dropRepeats_1.default(action_1.isEqualResult));
    var childSinks = isolate_1.default(actionbank_1.AllAction, 'AllAction')(__assign({}, sources, { goal: xstream_1.default.of({
    ...
    var twoSpeechbubblesAction = screen_1.TwoSpeechbubblesAction({
        goal: xstream_1.default.merge(childSinks.TwoSpeechbubblesAction, xstream_1.default.of(null).compose(delay_1.default(2000))),
        DOM: sources.DOM,
    });
...
function reducer(input$) {
    ...
    var transitionReducer$ = input$.map(function (input) { return function (prev) {
        ...
        if (prev.state === S.PEND && input.type === SIGType.GOAL) {
            ...
            if (input.value.some(function (r) { return r.status.status === action_1.Status.PREEMPTED
                || r.status.status === action_1.Status.ABORTED; })) {
...
exports.AllAction = AllAction_1.AllAction;
