...
function RobotApp(sources) {
    ...
    var twoSpeechbubblesResult$ = state$
        ...
        .compose(dropRepeats_1.default(action_1.isEqualResult));
    var allAction = isolate_1.default(AllAction_1.default, 'AllAction')(__assign({}, sources, { goal: xstream_1.default.of({
    ...
    var allActionReducer$ = allAction.state;
    var reducer$ = xstream_1.default.merge(parentReducer$, allActionReducer$);
