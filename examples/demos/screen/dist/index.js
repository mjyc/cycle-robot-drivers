...
function TwoSpeechbubblesAction(sources) {
    ...
    var vdom$ = xstream_1.default.combine(robotSpeechbubble.DOM, humanSpeechbubble.DOM).map(function (_a) {
        var robotVTree = _a[0],
            humanVTree = _a[1];
        return dom_1.div({ style: bubbles }, [dom_1.div({ style: style }, [dom_1.span(robotVTree)]), dom_1.div({ style: style }, [dom_1.span(humanVTree)])]);
    });
    return {
        DOM: vdom$,
        result: result
