...
function main(sources) {
  ...
  // main logic
  var speechbubbles$ = _xstream2.default.merge(_xstream2.default.of({
    message: 'How are you?',
    choices: ['Good', 'Bad']
...
var isolate_1 = __importDefault(require("@cycle/isolate"));
var action_1 = require("@cycle-robot-drivers/action");
var action_2 = require("@cycle-robot-drivers/action");
...
function input(goal$, humanSpeechbubbleResult$, robotSpeechbubbleResult$) {
    return xstream_1.default.merge(goal$.filter(function (goal) {
        return typeof goal !== 'undefined';
    }).map(function (goal) {
        if (goal === null) {
            ...
            var value = !!goal.goal_id ? goal : action_2.initGoal(goal);
            return {
                type: InputType.GOAL,
...
function main(sources) {
    var input$ = input(xstream_1.default.fromObservable(sources.goal),
    // xs.never(),
    xstream_1.default.fromObservable(sources.RobotSpeechbubble.result), xstream_1.default.fromObservable(sources.HumanSpeechbubble.result));
    var machine$ = transitionReducer(input$).fold(function (state, reducer) {
        return reducer(state);
    }, null).drop(1); // drop "null";
    var sinks = output(machine$);
...
function wrappedMain(sources) {
    sources.proxies = {
        RobotSpeechbubble: xstream_1.default.create(),
        HumanSpeechbubble: xstream_1.default.create()
    }, sources.RobotSpeechbubble = SpeechbubbleAction_1.IsolatedSpeechbubbleAction({
        goal: sources.proxies.RobotSpeechbubble,
        DOM: sources.DOM
    });
    sources.HumanSpeechbubble = SpeechbubbleAction_1.IsolatedSpeechbubbleAction({
    ...
    return function () {
        ...
        return {
            ...
            result: result,
            targets: {
                RobotSpeechbubble: RobotSpeechbubble,
                HumanSpeechbubble: HumanSpeechbubble
            }
        };
    }();
}
exports.TwoSpeechbubblesAction = action_1.powerup(wrappedMain, function (proxy, target) {
    return !!target && proxy.imitate(target);
});
function IsolatedTwoSpeechbubblesAction(sources) {
    return isolate_1.default(exports.TwoSpeechbubblesAction)(sources);
}
exports.IsolatedTwoSpeechbubblesAction = IsolatedTwoSpeechbubblesAction;


},{"./SpeechbubbleAction":123,"@cycle-robot-drivers/action":127,"@cycle/isolate":160,"@cycle/run/lib/adapt":161,"xstream":243}],125:[function(require,module,exports){
"use strict";
