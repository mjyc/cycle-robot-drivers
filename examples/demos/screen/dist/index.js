...
exports.createPoseDetectionVdom = function (styles) {
    if (styles === void 0) {
        styles = {};
    }
    return dom_1.div(".face", { style: styles.face }, [dom_1.div('.eye.left', {
...
function makeTabletFaceDriver(options) {
    ...
    return function (command$) {
        ...
        var vdom$ = xstream_1.default.of(exports.createPoseDetectionVdom(styles)).remember();
        var eventSource = {
