...
function main(sources) {
  ...
  // UI
  var vdom$ = _xstream2.default.combine(speechbubbleAction.DOM.startWith(''), sources.TabletFace.DOM.startWith('')).map(function (vdoms) {
...
function createTransition(options) {
    ...
    var styles = {
        message: __assign({ fontFamily: 'helvetica', fontSize: '12.5vmin', fontWeight: 'lighter' }, options.styles.message),
        button: __assign({ margin: '0 0.25em 0.25em 0.25em', backgroundColor: 'transparent', border: '0.05em solid black', borderRadius: '0.25em', fontFamily: 'helvetica', fontSize: '10vmin', fontWeight: 'lighter' }, options.styles.button),
    };
