...
function main(sources) {
  ...
  sources.TwoSpeechbubblesAction.result.filter(function (result) {
...
function createTransition() {
    ...
    }, _c[InputType.ROBOTSB_RESULT] = function (variables, inputValue) {
    ...
    }, _c[InputType.HUMANSB_RESULT] = function (variables, inputValue) {
        return action_1.isEqual(inputValue.status.goal_id, variables.goal_id) ? {
            state: State.RUNNING,
            variables: {
                goal_id: variables.goal_id,
