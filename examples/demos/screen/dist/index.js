...
function FacialExpressionAction(sources) {
    var input$ = input(sources.goal, sources.cancel || xstream_1.default.never(), sources.TabletFace.animationFinish);
