...
function main(sources) {
  sources.proxies = { // will be connected to "targets"
    ...
    SpeechbubbleAction: _xstream2.default.create()
  };
  ...
  // });
  // create action components
  sources.SpeechbubbleAction = (0, _screen.IsolatedSpeechbubbleAction)({
  ...
  // main logic
  var speechbubbles$ = _xstream2.default.merge(_xstream2.default.of('Hello there!').compose((0, _delay2.default)(1000)),
  // xs.of({
  //   message: 'How are you?',
  //   choices: ['Good', 'Bad']
  // }).compose(delay(2000)),
  _xstream2.default.of(['Good', 'Bad']).compose((0, _delay2.default)(2000)),
  // sources.TwoSpeechbubblesAction.result
  sources.SpeechbubbleAction.result.filter(function (result) {
  ...
  var vdom$ = _xstream2.default.combine(
  // sources.TwoSpeechbubblesAction.DOM,
  sources.SpeechbubbleAction.DOM, sources.TabletFace.DOM).map(function (_ref) {
...
function SpeechbubbleAction(sources) {
    var input$ = input(xstream_1.default.fromObservable(sources.goal), xstream_1.default.never());
    ...
    return {
        DOM: xstream_1.default.of((snabbdom_pragma_1.default.createElement("span", null, 'hello world'))),
        result: adapt_1.adapt(result$),
    };
}
...
},{"@cycle-robot-drivers/action":127,"@cycle/isolate":130,"@cycle/run/lib/adapt":131,"snabbdom-pragma":133,"xstream":137}],124:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
