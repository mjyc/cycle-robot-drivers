                    ...
                    DOM: {
                        goal: inputValue.goal.type === SpeechbubbleType.MESSAGE
                            ...
                            : inputValue.goal.type === SpeechbubbleType.CHOICE
                                ? dom_1.span(inputValue.goal.value.map(function (text) { return dom_1.button('.choice', text); })) : null
                    },
                },
            }); },
            _b),
...
function transitionReducer(input$) {
    ...
    var transition = createTraxnsition();
...
function output(machine$) {
    ...
    return {
        DOM: adapt_1.adapt(outputs$
            ...
            .map(function (outputs) { return outputs.DOM.goal; }).startWith(null)),
...
},{"./SpeechbubbleAction":123,"@cycle-robot-drivers/action":127,"@cycle/isolate":160,"@cycle/run/lib/adapt":161,"snabbdom-pragma":226,"xstream":243,"xstream/extra/dropRepeats":241}],125:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
