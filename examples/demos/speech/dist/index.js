...
function isEqualGoalStatus(first, second) {
    return isEqual(first.goal_id, second.goal_id) && first.status === second.status;
}
...
function powerup(main, connect) {
    return function (sources) {
        ...
        var targets = sinks.targets,
            sinksWithoutTargets = __rest(sinks, ["targets"]);
...
var _cjs = require('../../../../action/lib/cjs');
...
function main(sources) {
  ...
  var vdom$ = speechRecognitionAction.result.filter(function (r) {
    return r.status.status === _cjs.Status.SUCCEEDED;
...
},{"../../../../action/lib/cjs":1,"@cycle-robot-drivers/speech":70,"@cycle/dom":17,"@cycle/isolate":24,"@cycle/run":27,"@cycle/state":31,"xstream":66,"xstream/extra/sampleCombine":65}],68:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
