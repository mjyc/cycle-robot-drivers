...
function main(sources) {
  ...
  var synthGoal$ = say$.compose((0, _sampleCombine2.default)(inputText$)).filter(function (_ref) {
    ...
    return { goal_id: { goal_id: Date.now(), id: 'ss' }, goal: text };
  });
  ...
  // speech recognition
  var recogGoal$ = sources.DOM.select('#listen').events('click').mapTo({ goal_id: { goal_id: Date.now(), id: 'sr' }, goal: {} });
...
},{"@cycle-robot-drivers/speech":70,"@cycle/dom":17,"@cycle/isolate":24,"@cycle/run":27,"@cycle/state":31,"xstream":66,"xstream/extra/sampleCombine":65}],68:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || function () {
    __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
...
},{"@cycle/run/lib/adapt":73,"xstream":78,"xstream/extra/fromEvent":77}],72:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"@cycle/run/lib/adapt":73,"xstream":78,"xstream/extra/fromEvent":77}],73:[function(require,module,exports){
(function (global){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
function getGlobal() {
