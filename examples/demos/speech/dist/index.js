...
},{"./fromEvent":15,"@cycle/run/lib/adapt":25,"xstream":66}],5:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var xstream_1 = require("xstream");
var adapt_1 = require("@cycle/run/lib/adapt");
...
},{"./fromEvent":15,"@cycle/run/lib/adapt":25,"xstream":66}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./ElementFinder":6,"./PriorityQueue":10,"./RemovalSet":11,"./ScopeChecker":12,"./SymbolTree":13,"./fromEvent":15,"./utils":23,"xstream":66}],8:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var utils_1 = require("./utils");
var SymbolTree_1 = require("./SymbolTree");
...
},{"xstream":66}],16:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./EventDelegator":7,"./IsolateModule":8,"./MainDOMSource":9,"./VNodeWrapper":14,"./modules":21,"./utils":23,"snabbdom":52,"snabbdom/tovnode":54,"xstream":66,"xstream/extra/concat":63,"xstream/extra/sampleCombine":65}],20:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var xstream_1 = require("xstream");
var adapt_1 = require("@cycle/run/lib/adapt");
...
},{"@cycle/run/lib/adapt":25,"xstream":66}],21:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"@cycle/run/lib/adapt":25,"xstream":66}],25:[function(require,module,exports){
(function (global){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
function getGlobal() {
...
},{"./adapt":26,"quicktask":36,"xstream":66}],29:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || function () {
    __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
...
},{"./pickCombine":32,"./pickMerge":33,"@cycle/isolate":24,"@cycle/run/lib/adapt":25,"xstream":66}],30:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || function () {
    __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
...
},{"@cycle/run/lib/adapt":25,"xstream/extra/dropRepeats":64}],31:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"xstream":66}],33:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var xstream_1 = require("xstream");
...
},{"xstream":66}],34:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var xstream_1 = require("xstream");
var concat_1 = require("xstream/extra/concat");
...
},{"./StateSource":30,"quicktask":36,"xstream":66,"xstream/extra/concat":63}],35:[function(require,module,exports){
...
},{"symbol-observable":56}],67:[function(require,module,exports){
'use strict';
...
function main(sources) {
  ...
  var synthGoal$ = say$.compose((0, _sampleCombine2.default)(inputText$)).filter(function (_ref) {
    ...
    return { goal_id: '' + new Date().getTime(), goal: text };
  });
  ...
  // speech recognition
  var recogGoal$ = sources.DOM.select('#listen').events('click').mapTo({ goal_id: '' + new Date().getTime(), goal: {} });
...
},{"@cycle-robot-drivers/action":1,"@cycle-robot-drivers/speech":70,"@cycle/dom":17,"@cycle/isolate":24,"@cycle/run":27,"@cycle/state":31,"xstream":66,"xstream/extra/sampleCombine":65}],68:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
...
function input(goal$, cancel$, startEvent$, endEvent$, errorEvent$, resultEvent$) {
    return xstream_1.default.merge(goal$.map(function (goal) { return ({
        type: InputType.GOAL,
        value: goal,
    }); }), cancel$.mapTo({ type: InputType.CANCEL, value: null }), startEvent$.mapTo({ type: InputType.START, value: null }), endEvent$.mapTo({ type: InputType.END, value: null }), errorEvent$.map(function (event) { return ({ type: InputType.ERROR, value: event }); }), resultEvent$.map(function (event) { return ({ type: InputType.RESULT, value: event }); }));
}
...
function status(reducerState$) {
    var active$ = reducerState$
        .filter(function (rs) { return rs.state === State.RUNNING; })
        .map(function (rs) { return ({ goal_id: rs.variables.goal_id, status: action_1.Status.ACTIVE }); });
    var done$ = reducerState$
        .filter(function (rs) { return !!rs.result; })
        .map(function (rs) { return rs.result.status; });
    var initGoalStatus = {
        goal_id: null,
        status: action_1.Status.SUCCEEDED,
    };
    return xstream_1.default.merge(active$, done$)
...
function SpeechRecognitionAction(sources) {
    var input$ = input(sources.goal, sources.cancel, sources.SpeechRecognition.events('start'), sources.SpeechRecognition.events('end'), sources.SpeechRecognition.events('error'), sources.SpeechRecognition.events('result'));
    var reducer = transitionReducer(input$);
    var result$ = sources.state.stream.map(function (rs) { return rs.result; }).filter(function (rs) { return !!rs; });
    var status$ = status(sources.state.stream);
    var outputs = output(sources.state.stream);
    return __assign({ state: reducer, status: status$, result: result$ }, outputs);
}
exports.SpeechRecognitionAction = SpeechRecognitionAction;
var _a, _b, _c, _d;

},{"@cycle-robot-drivers/action":1,"xstream":78,"xstream/extra/dropRepeats":76}],69:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
...
function input(goal$, cancel$, startEvent$, endEvent$) {
    ...
    }), cancel$.mapTo({ type: InputType.CANCEL, value: null }), startEvent$.mapTo({ type: InputType.START, value: null }), endEvent$.mapTo({ type: InputType.END, value: null }));
}
var transitionTable = (_a = {},
    _a[State.DONE] = (_b = {},
        _b[InputType.GOAL] = State.RUNNING,
...
function SpeechSynthesisAction(sources) {
    var input$ = input(sources.goal, sources.cancel, sources.SpeechSynthesis.events('start'), sources.SpeechSynthesis.events('end'));
    var reducer = transitionReducer(input$);
    var result$ = sources.state.stream.map(function (rs) { return rs.result; }).filter(function (rs) { return !!rs; });
    var status$ = status(sources.state.stream);
    var outputs = output(sources.state.stream);
...
},{"@cycle-robot-drivers/action":1,"xstream":78,"xstream/extra/dropRepeats":76}],70:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./SpeechRecognitionAction":68,"./SpeechSynthesisAction":69,"./makeSpeechRecognitionDriver":71,"./makeSpeechSynthesisDriver":72}],71:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"@cycle/run/lib/adapt":73,"xstream/extra/fromEvent":77}],72:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"@cycle/run/lib/adapt":73,"xstream/extra/fromEvent":77}],73:[function(require,module,exports){
(function (global){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
function getGlobal() {
...
},{"../index":78,"dup":64}],77:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var index_1 = require("../index");
...
},{"../index":78}],78:[function(require,module,exports){
arguments[4][66][0].apply(exports,arguments)
},{"dup":66,"symbol-observable":74}]},{},[67])
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
