...
},{"./fromEvent":20,"@cycle/run/lib/adapt":30,"xstream":71}],10:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var xstream_1 = require("xstream");
var adapt_1 = require("@cycle/run/lib/adapt");
...
},{"./fromEvent":20,"@cycle/run/lib/adapt":30,"xstream":71}],11:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./ElementFinder":11,"./PriorityQueue":15,"./RemovalSet":16,"./ScopeChecker":17,"./SymbolTree":18,"./fromEvent":20,"./utils":28,"xstream":71}],13:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var utils_1 = require("./utils");
var SymbolTree_1 = require("./SymbolTree");
...
},{"xstream":71}],21:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./EventDelegator":12,"./IsolateModule":13,"./MainDOMSource":14,"./VNodeWrapper":19,"./modules":26,"./utils":28,"snabbdom":57,"snabbdom/tovnode":59,"xstream":71,"xstream/extra/concat":68,"xstream/extra/sampleCombine":70}],25:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var xstream_1 = require("xstream");
var adapt_1 = require("@cycle/run/lib/adapt");
...
},{"@cycle/run/lib/adapt":30,"xstream":71}],26:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"@cycle/run/lib/adapt":30,"xstream":71}],30:[function(require,module,exports){
(function (global){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
function getGlobal() {
...
},{"./adapt":31,"quicktask":41,"xstream":71}],34:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || function () {
    __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
...
},{"./pickCombine":37,"./pickMerge":38,"@cycle/isolate":29,"@cycle/run/lib/adapt":30,"xstream":71}],35:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || function () {
    __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
...
},{"@cycle/run/lib/adapt":30,"xstream/extra/dropRepeats":69}],36:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"xstream":71}],39:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var xstream_1 = require("xstream");
var concat_1 = require("xstream/extra/concat");
...
},{"./StateSource":35,"quicktask":41,"xstream":71,"xstream/extra/concat":68}],40:[function(require,module,exports){
...
},{"../index":71,"dup":7}],70:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var index_1 = require("../index");
var NO = {};
...
},{"dup":8,"symbol-observable":61}],72:[function(require,module,exports){
'use strict';
...
function main(sources) {
  ...
  var synthGoal$ = say$.compose((0, _sampleCombine2.default)(inputText$)).filter(function (_ref) {
    ...
    return { goal_id: { stamp: Date.now(), id: 'ss' }, goal: text };
  });
  ...
  speechSynthesisAction.status.addListener({ next: function next(s) {
  ...
  speechRecognitionAction.status.addListener({ next: function next(s) {
...
},{"@cycle-robot-drivers/speech":75,"@cycle/dom":22,"@cycle/isolate":29,"@cycle/run":32,"@cycle/state":36,"xstream":71,"xstream/extra/sampleCombine":70}],73:[function(require,module,exports){
"use strict";
...
function input(goal$, cancel$, startEvent$, endEvent$, errorEvent$, resultEvent$) {
    ...
    }), cancel$.mapTo({ type: InputType.CANCEL, value: null }), startEvent$.mapTo({ type: InputType.START, value: null }), endEvent$.mapTo({ type: InputType.END, value: null }), errorEvent$.map(function (event) {
...
function SpeechRecognitionAction(sources) {
    var input$ = input(sources.goal, sources.cancel || xstream_1.default.never(), sources.SpeechRecognition.events('start'), sources.SpeechRecognition.events('end'), sources.SpeechRecognition.events('error'), sources.SpeechRecognition.events('result'));
...
},{"@cycle-robot-drivers/action":1,"xstream":83,"xstream/extra/dropRepeats":81}],74:[function(require,module,exports){
"use strict";
...
function input(goal$, cancel$, startEvent$, endEvent$) {
    ...
    }), cancel$.map(function (v) {
        return { type: InputType.CANCEL, value: v };
...
function SpeechSynthesisAction(sources) {
    var input$ = input(sources.goal, sources.cancel || xstream_1.default.never(), sources.SpeechSynthesis.events('start'), sources.SpeechSynthesis.events('end'));
    var reducer = transitionReducer(input$);
    var status$ = status(sources.state.stream);
    var outputs = output(sources.state.stream);
    return __assign({ state: reducer, status: status$ }, outputs);
...
},{"@cycle-robot-drivers/action":1,"xstream":83,"xstream/extra/dropRepeats":81}],75:[function(require,module,exports){
"use strict";
...
},{"./SpeechRecognitionAction":73,"./SpeechSynthesisAction":74,"./makeSpeechRecognitionDriver":76,"./makeSpeechSynthesisDriver":77}],76:[function(require,module,exports){
"use strict";
...
},{"@cycle/run/lib/adapt":78,"xstream":83,"xstream/extra/fromEvent":82}],77:[function(require,module,exports){
"use strict";
...
},{"@cycle/run/lib/adapt":78,"xstream":83,"xstream/extra/fromEvent":82}],78:[function(require,module,exports){
(function (global){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
function getGlobal() {
...
arguments[4][7][0].apply(exports,arguments)
},{"../index":83,"dup":7}],82:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var index_1 = require("../index");
