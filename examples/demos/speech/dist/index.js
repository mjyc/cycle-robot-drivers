...
function input(goal$, cancel$, startEvent$, delayedendEvent$) {
    ...
    }), cancel$.map(function (val) { return ({ type: InputType.CANCEL, value: val }); }), startEvent$.mapTo({ type: InputType.START, value: null }), delayedendEvent$.mapTo({ type: InputType.END, value: null }));
}
var transitionTable = (_a = {},
    _a[State.WAIT] = (_b = {},
        _b[InputType.GOAL] = State.RUN,
