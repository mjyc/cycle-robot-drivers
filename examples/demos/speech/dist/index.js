...
function main(sources) {
  var vdom$ = sources.DOM.select('.myinput').events('input').map(function (ev) {
    ...
    return (0, _dom.div)([(0, _dom.button)('.say', 'say'), (0, _dom.input)('.myinput', { attrs: { type: 'text' } }), (0, _dom.br)(), (0, _dom.button)('listen'), (0, _dom.label)('heard: hello!')]);
  });

  var click$ = sources.DOM.select('.say').events('click');

  var speechSynthesisAction = (0, _speech.SpeechSynthesisAction2)({
...
},{"@cycle-robot-drivers/speech":59,"@cycle/dom":14,"@cycle/run":23,"xstream":55}],57:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
...
},{"@cycle-robot-drivers/action":62,"@cycle/run/lib/adapt":65,"xstream":69}],58:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
...
function transitionReducer2(input$) {
    var initReducer$ = xstream_1.default.of(function initReducer(prev) {
        return {
            state: State.DONE,
            variables: {
...
function SpeechSynthesisAction(sources) {
    ...
    var state$ = transitionReducer2(input$)
        .fold(function (state, reducer) { return reducer(state); }, null)
        .drop(1); // drop "null"
    var outputs$ = state$.map(function (state) { return state.outputs; })
        .filter(function (outputs) { return !!outputs; });
...
var transitionTable2 = (_e = {},
    _e[State.DONE] = (_f = {},
        _f[InputType.GOAL] = State.RUNNING,
        _f),
    _e[State.RUNNING] = (_g = {},
        _g[InputType.GOAL] = State.PREEMPTING,
        _g[InputType.CANCEL] = State.PREEMPTING,
        _g[InputType.START] = State.RUNNING,
        _g[InputType.END] = State.DONE,
        _g),
    _e[State.PREEMPTING] = (_h = {},
        _h[InputType.END] = State.DONE,
        _h),
    _e);
function transition2(prevState, prevVariables, input) {
    var states = transitionTable2[prevState];
    if (!states) {
        throw new Error("Invalid prevState=\"" + prevState + "\"");
    }
    var state = states[input.type];
...
function SpeechSynthesisAction2(sources) {
    var input$ = input2(xstream_1.default.fromObservable(sources.goal), xstream_1.default.fromObservable(sources.cancel), xstream_1.default.fromObservable(sources.SpeechSynthesis.events('start')), xstream_1.default.fromObservable(sources.SpeechSynthesis.events('end')));
    var state$ = transitionReducer(input$)
        .fold(function (state, reducer) { return reducer(state); }, null)
        .drop(1); // drop "null"
    var outputs$ = state$.map(function (state) { return state.outputs; })
    ...
    var result$ = state$.map(function (state) { return state.result; }).filter(function (result) { return !!result; });
    return {
        status: xstream_1.default.never(),
        result: result$,
        SpeechSynthesis: outputs$.map(function (o) { return o.args; }),
    };
    // return {
    //   status: xs.never(),
    //   result: xs.never(),
...
exports.SpeechSynthesisAction2 = SpeechSynthesisAction2;
var _a, _b, _c, _d, _e, _f, _g, _h;

},{"@cycle-robot-drivers/action":62,"@cycle/run/lib/adapt":65,"xstream":69}],59:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
exports.SpeechSynthesisAction2 = SpeechSynthesisAction_1.SpeechSynthesisAction2;
...
},{"./SpeechRecognitionAction":57,"./SpeechSynthesisAction":58,"./makeSpeechRecognitionDriver":60,"./makeSpeechSynthesisDriver":61}],60:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"@cycle/run/lib/adapt":65,"xstream/extra/fromEvent":68}],61:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"@cycle/run/lib/adapt":65,"xstream/extra/fromEvent":68}],62:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./types":63,"./utils":64}],63:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var Status;
(function (Status) {
...
},{"./ponyfill.js":67}],67:[function(require,module,exports){
