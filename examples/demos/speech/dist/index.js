...
function main(sources) {
  ...
  var vdom$ = _xstream2.default.of((0, _dom.div)([(0, _dom.button)('.say', 'say'), (0, _dom.input)('.inputtext', { attrs: { type: 'text' } }), (0, _dom.br)(), (0, _dom.button)('.listen', 'listen'), (0, _dom.label)('heard: hello!')]));
...
},{"@cycle-robot-drivers/speech":70,"@cycle/dom":17,"@cycle/run":27,"@cycle/state":31,"xstream":66,"xstream/extra/sampleCombine":65}],68:[function(require,module,exports){
"use strict";
...
},{"@cycle-robot-drivers/action":1,"@cycle/run/lib/adapt":73,"xstream":78}],69:[function(require,module,exports){
"use strict";
...
function status(reducerState$) {
    ...
    return xstream_1.default.merge(active$, done$).compose(dropRepeats_1.default(action_1.isEqualGoalStatus)).startWith(initGoalStatus);
}
function output(reducerState$) {
    ...
    return {
        SpeechSynthesis: outputs$.map(function (o) {
...
function SpeechSynthesisAction(sources) {
    ...
    var result$ = sources.state.stream.map(function (rs) {
        return rs.result;
    }).filter(function (rs) {
        return !!rs;
    });
