...
var gyronorm_complete_1 = __importDefault(require("gyronorm/dist/gyronorm.complete"));
 ...
 *
 */
function makeGyronormDriver(options) {
    if (options === void 0) { options = {}; }
    var gn = new gyronorm_complete_1.default(options);
    return function () {
...
},{"symbol-observable":52}],62:[function(require,module,exports){
'use strict';
...
var _cycleGyronormDriver = require('cycle-gyronorm-driver');

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function main(sources) {
  sources.GyroNorm.addListener({ next: function next(f) {
      return console.log(f);
    } });
  var vdom$ = sources.GyroNorm.replaceError(function (err) {
    return _xstream2.default.of(false);
  }).map(function (data) {
    return !data ? (0, _dom.div)(['To view this demo, browse to ', (0, _dom.a)({ props: { href: 'https://cycle-robot-drivers-demos-gyronorm.stackblitz.io' } }, 'https://cycle-robot-drivers-demos-gyronorm.stackblitz.io'), ' on your mobile device']) : (0, _dom.pre)('DeviceOrientation: ' + JSON.stringify(data.do) + '\nDeviceMotion: ' + JSON.stringify(data.dm));
  });
  return {
    DOM: vdom$
  };
