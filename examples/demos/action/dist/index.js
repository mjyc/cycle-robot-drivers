...
function main(sources) {
  ...
  var reducer = speechbubbleAction.state;
  return {
    DOM: vdom$,
    state: reducer
  };
...
function createTransition(options) {
    ...
    var transitionTable = (_a = {}, _a[State.WAIT] = (_b = {}, _b[InputType.GOAL] = function (variables, inputValue) {
        return {
            state: State.RUN,
            variables: {
    ...
    }, _b), _a[State.RUN] = (_c = {}, _c[InputType.GOAL] = function (variables, inputValue) {
        return {
            state: State.RUN,
            variables: {
                goal_id: inputValue.goal_id,
