...
function main(sources) {
  ...
  var facialExpressionResult$ = state$.compose((0, _action.selectActionResult)('FacialExpressionAction'));
  var speechbubbleResult$ = state$.compose((0, _action.selectActionResult)('SpeechbubbleAction'));

  // "main" component
  var AllAction = (0, _action.makeConcurrentAction)(['FacialExpressionAction', 'SpeechbubbleAction'], false);
  var childSinks = (0, _isolate2.default)(AllAction, 'AllAction')(_extends({}, sources, {
    goal: _xstream2.default.of({
  ...
  childSinks.result.addListener({ next: function next(r) {
      return console.log('result', r);
    } });

  // Define Actions
  var facialExpressionAction = (0, _isolate2.default)(_screen.FacialExpressionAction, 'FacialExpressionAction')(_extends({}, childSinks.FacialExpressionAction, {
    state: sources.state,
    TabletFace: sources.TabletFace
  }));
  var speechbubbleAction = (0, _isolate2.default)(_screen.SpeechbubbleAction, 'SpeechbubbleAction')(_extends({}, childSinks.SpeechbubbleAction, {
  ...
  // Define Reducers
  var reducer$ = _xstream2.default.merge(facialExpressionAction.state, speechbubbleAction.state, childSinks.state);
...
},{"@cycle-robot-drivers/action":1,"@cycle-robot-drivers/screen":76,"@cycle/dom":22,"@cycle/isolate":29,"@cycle/run":32,"@cycle/state":36,"xstream":72,"xstream/extra/delay":69}],74:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || function () {
    __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
...
function transitionReducer(input$) {
    ...
    var inputReducer$ = input$
        ...
        return __assign({}, prev, transition(prev, input));
    }; });
