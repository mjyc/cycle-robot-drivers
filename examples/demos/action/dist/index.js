...
function main(sources) {
  ...
  var robotSpeechbubbleAction = (0, _isolate2.default)(_screen.SpeechbubbleAction, 'RobotSpeechbubbleAction')({
    state: sources.state,
    DOM: sources.DOM,
    goal: _xstream2.default.of({ goal_id: { stamp: Date.now(), id: 'hsb' }, goal: 'ROBOT' }).compose((0, _delay2.default)(1000))
  });
  var humanSpeechbubbleAction = (0, _isolate2.default)(_screen.SpeechbubbleAction, 'HumanSpeechbubbleAction')({
    state: sources.state,
    DOM: sources.DOM,
    goal: _xstream2.default.of({ goal_id: { stamp: Date.now(), id: 'hsb' }, goal: 'HUMAN' }).compose((0, _delay2.default)(1000))
  });
  ...
  var reducer = _xstream2.default.merge(robotSpeechbubbleAction.state, humanSpeechbubbleAction.state);
  return {
    DOM: vdom$,
    state: reducer
  };
