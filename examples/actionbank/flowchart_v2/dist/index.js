    ...
    var transitionReducer$ = input$.map(function (input) { return function (prev) {
        ...
        if (prev.state === S.PEND && input.type === SIGType.GOAL) {
            ...
            if (node && node.type === 'MONOLOGUE') {
                ...
                return __assign({}, prev, { state: S.INSTRUCTION, variables: {
                        goal_id: input.value.goal_id,
                        flowchart: flowchart,
                        node: node,
                    }, outputs: {
...
function RobotApp(sources) {
    ...
    var twoSpeechbubblesGoal$ = xstream_1.default.merge(xstream_1.default.combine(mainScreen$, childSinks.result.startWith(null)).map(function (x) { return x[0]; }), childSinks.TwoSpeechbubblesAction);
