...
function RobotApp(sources) {
    ...
    var childSinks = isolate_1.default(actionbank_1.QAWithScreenAction)({
        goal: xstream_1.default.of({
            question: 'Start with butter, onions, carrots, celery, garlic until cooked down',
            answers: ['Done'],
