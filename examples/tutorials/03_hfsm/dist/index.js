...
function output(reducerState$) {
  var outputs$ = reducerState$.filter(function (s) {
    return !!s.outputs;
  }).map(function (s) {
    return s.outputs;
  });
